...
function adjustSensorGraphic(sensorPosition, sensorGroup) {
    ...
    document
        .getElementById(`${sensorPosition}-LG`)
        .setAttribute("r", radiusSetting);
...
function backColour() {
    ...
    document
        ...
        .setAttribute("style", `background-color:${x}`);
}
...
function ParkingSensors({
    ...
    function setSensorGraphicPosition(sensorGroup, value) {
        // set the radius of the gradient fill which creates the effect of the sensors graphic moving in and out
        let radiusSetting = convertRange(
            value,
            sensorScale,
            getRadiusRange(sensorGroup)
        );
            ...
            <div id="SVG-div">
                ...
                <svg id="SVGCAR" width={size} height={size*1.88} viewBox="0 0 128 241">
                    ...
                    <linearGradient id="frontLeftLeft">
                        ...
                        <stop
                            id="FLL-stop2"
                            style={setSensorGraphicColour(0, sensorFLL)}
                            offset="100%"
                        />
                    </linearGradient>
                    <radialGradient
                    ...
                    <linearGradient id="frontCenterLeft">
                        ...
                        <stop
                            id="FCL-stop2"
                            style={setSensorGraphicColour(0, sensorFCL)}
                            offset="100%"
                        />
                    </linearGradient>
                    <radialGradient
                    ...
                    <linearGradient id="frontCenterRight">
                        ...
                        <stop
                            id="FCR-stop2"
                            style={setSensorGraphicColour(0, sensorFCR)}
                            offset="100%"
                        />
                    </linearGradient>
                    <radialGradient
                    ...
                    <linearGradient id="frontRightRight">
                        ...
                        <stop
                            id="FRR-stop2"
                            style={setSensorGraphicColour(0, sensorFRR)}
                            offset="100%"
                        />
                    </linearGradient>
                    <radialGradient
